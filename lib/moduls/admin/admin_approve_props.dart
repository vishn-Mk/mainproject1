...
import 'package:mainproject1/moduls/admin/props_details_screen.dart';


class AdminApprovpPrpops extends StatelessWidget {
  const AdminApprovpPrpops({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PropsDetailsScreen(),
                        ),
                      );
                    },
                  ),
