...
import 'package:mainproject1/moduls/player/bookings/player_ticket_view.dart';
...
class PlayerTournamentsDetailsScreen extends StatefulWidget {
  const PlayerTournamentsDetailsScreen(
      {super.key, required this.tournamentDetails});

  final Map<String, dynamic> tournamentDetails;

  @override
  State<PlayerTournamentsDetailsScreen> createState() =>
      _PlayerTournamentsDetailsScreenState();
}

class _PlayerTournamentsDetailsScreenState
    extends State<PlayerTournamentsDetailsScreen> {
      ...
      if (response.statusCode == 200) {
        if (context.mounted) {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => PlayerTicketBookingView(
